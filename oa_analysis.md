...
![](oa_analysis_files/figure-markdown_github/unnamed-chunk-9-2.png)
...
![](oa_analysis_files/figure-markdown_github/unnamed-chunk-12-1.png) As a proportion of all articles, deposits into repositories has been going up, with a recent drop. Embargos probaby play a large part in this, though deposit into places like ResearchGate (not included in our repository numbers) rather than institutional repositories may as well.
...
```
    ...
    ##  (Other)                                                                             :11102  
    ##       year      found_green                                journal     
    ##  Min.   :2009   Mode :logical   ChemInform                     :  491  
    ##  1st Qu.:2010   FALSE:22507     PLoS ONE                       :  233  
    ##  Median :2012   TRUE :5367      Advanced Materials Research    :  202  
    ##  Mean   :2012                   Applied Mechanics and Materials:  143  
    ##  3rd Qu.:2014                   Cancer Res                     :   78  
    ##  Max.   :2015                   Reactions Weekly               :   77  
    ##                                 (Other)                        :26650  
    ##                                      publisher    
    ##  Elsevier BV                              : 6100  
    ...
    ##                                license          random         
    ##                                    :23753   Min.   :0.0000000  
    ##  cc-by                             : 2216   1st Qu.:0.0004000  
    ##  cc-by-nc-nd                       :  670   Median :0.0008000  
    ##  cc-by-nc                          :  636   Mean   :0.0007918  
    ##  elsevier-specific: oa user license:  343   3rd Qu.:0.0012000  
    ##  cc-by-nc-sa                       :  162   Max.   :0.0016000  
    ##  (Other)                           :   94                      
    ##  is_open_license      oa        is_modern     
    ##  Mode :logical   closed:16760   Mode:logical  
    ##  FALSE:24113     bronze: 5047   TRUE:27874    
    ##  TRUE :3761      hybrid: 1887                 
    ##                  gold  : 2193                 
    ##                  green : 1987                 
    ##                                               
    ## 
...
```
    ...
    ##                                                   evidence   
    ##  oa journal (via journal title in doaj)               :2173  
    ##  hybrid (via page says license)                       : 916  
    ##  hybrid (via crossref license)                        : 820  
    ##  hybrid (via free pdf)                                : 115  
    ...
    ##  (Other)                                                                    :4115  
    ##       year      found_green    
    ##  Min.   :2009   Mode :logical  
    ##  1st Qu.:2011   FALSE:1891     
    ##  Median :2013   TRUE :2230     
    ##  Mean   :2013                  
    ##  3rd Qu.:2014                  
    ##  Max.   :2015                  
    ##                                
    ...
    ##  (Other)                          :2124  
    ##                                license         random         
    ##  cc-by                             :2216   Min.   :0.0000000  
    ##  cc-by-nc-nd                       : 670   1st Qu.:0.0004000  
    ##  cc-by-nc                          : 636   Median :0.0008000  
    ##  elsevier-specific: oa user license: 343   Mean   :0.0007885  
    ##  cc-by-nc-sa                       : 162   3rd Qu.:0.0012000  
    ##  cc-by-sa                          :  59   Max.   :0.0016000  
    ##  (Other)                           :  35                      
    ##  is_open_license      oa       is_modern     
    ##  Mode :logical   closed:   0   Mode:logical  
    ##  FALSE:366       bronze: 115   TRUE:4121     
    ##  TRUE :3755      hybrid:1739                 
    ##                  gold  :2187                 
    ##                  green :  80                 
    ##                                              
    ## 
...
![](oa_analysis_files/figure-markdown_github/unnamed-chunk-15-1.png)
...
![](oa_analysis_files/figure-markdown_github/unnamed-chunk-15-2.png)
