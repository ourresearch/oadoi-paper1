...
# articles_raw <- read.csv("export_study2_20170509.csv")
...
articles_all$oa_orig = "closed"
articles_all$oa_orig[articles_all$oa_color=="green"] = "green_only"
articles_all$oa_orig[articles_all$oa_color=="gold"] = "gold_doaj"
articles_all$oa_orig[articles_all$oa_color=="blue" & articles_all$is_open_license] = "gold_not_doaj"
articles_all$oa_orig[articles_all$oa_color=="blue" & !articles_all$is_open_license] = "free"
...
articles_all = articles_all %>% filter(!is.na(oa))

# handy for color-coding later
oa_color_map = scale_fill_manual(values=c("#777777", "#FFF59D", "#FFC107", "#FFA107", "#4CAF50"))
...
oa_color_map = scale_fill_manual(values=c("#777777", "#ffdc3b", "#FFC107", "#FF9800", "#4CAF50"))
...
publishers_oa %>% slice(1:90) %>% ggplot(aes(x=publisher, y=n, fill=oa)) + 
